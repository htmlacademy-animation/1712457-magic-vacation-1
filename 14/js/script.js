...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* methods animation https://easings.net/ru */
...
const animMethod = Object.freeze({
  easeLinear,
  easeInCubic,
  easeOutCubic,
  easeInExpo,
...
/* harmony default export */ __webpack_exports__["default"] = (animMethod);


/***/ }),

/***/ "./source/js/modules/animation-text.js":
/*!*********************************************!*\
  !*** ./source/js/modules/animation-text.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AnimationText; });
class AnimationText {
  constructor(
      elementSelector,
      timer,
...
/***/ "./source/js/modules/base-page.js":
/*!****************************************!*\
  !*** ./source/js/modules/base-page.js ***!
  \****************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/crocodile-canvas-animation.js":
/*!*********************************************************!*\
  !*** ./source/js/modules/crocodile-canvas-animation.js ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CrocodileAnimation; });
...
class CrocodileAnimation extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
  ...
  initFlamingoAnimations() {
    ...
    this.animations.push(new _helpers_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      delay: 1700,
      duration: 1800,
      easing: _helpers_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutExpo
    }));
  }
...
/***/ "./source/js/modules/heading-animation.js":
/*!************************************************!*\
  !*** ./source/js/modules/heading-animation.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _win_canvas_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./win-canvas-animation.js */ "./source/js/modules/win-canvas-animation.js");
/* harmony import */ var _crocodile_canvas_animation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./crocodile-canvas-animation.js */ "./source/js/modules/crocodile-canvas-animation.js");
  ...
  document.querySelectorAll(`.game__button`).forEach((button) => {
    button.addEventListener(`click`, () => {
      if (button.dataset.target === `result`) {
        const winCanvasAnim = new _win_canvas_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
        winCanvasAnim.start();
      } else if (button.dataset.target === `result3`) {
        const crocodileAnim = new _crocodile_canvas_animation_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
        crocodileAnim.start();
      }
    });
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _prize_counter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prize-counter */ "./source/js/modules/prize-counter.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const prizesCountCases = new _prize_counter__WEBPACK_IMPORTED_MODULE_0__["default"]('.js-prizes-count-cases', 1, 7);
  const prizesCountCodes = new _prize_counter__WEBPACK_IMPORTED_MODULE_0__["default"]('.js-prizes-count-codes', 11, 900, true);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PrizeCounter; });
class PrizeCounter {
  constructor(
    elementSelector,
    startCount,
    ...
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        [].slice.call(results).forEach(function (el) {
          ...
          el.classList.remove(`screen--show_animation`);
        ...
        setTimeout(() => {
          targetEl[0].classList.add(`screen--show_animation`);
        }, 100);
      });
    }
...
/***/ "./source/js/modules/rules-page.js":
/*!*****************************************!*\
  !*** ./source/js/modules/rules-page.js ***!
  \*****************************************/
/*! exports provided: default */
...
class Scene2D {
  constructor(options) {
    ...
    this.images = {};
    this.elements = {};
    this.settings = options.elements;
    this.locals = {};
    this.isLoaded = false;
  ...
  initElements() {
    for (const name in this.settings) {
      if (Object.prototype.hasOwnProperty.call(this.settings, name)) {
        const o = this.settings[name];

        this.elements[name] = {};
        this.elements[name].imageId = o.imageId;
        this.elements[name].before = o.before;
        this.elements[name].after = o.after;
        this.elements[name].x = o.x;
        this.elements[name].y = o.y;
        this.elements[name].size = o.size;
        this.elements[name].opacity = o.opacity;

        this.elements[name].transforms = {};
        this.elements[name].transforms.rotate = o.transforms.rotate;
        this.elements[name].transforms.translateX = o.transforms.translateX;
        this.elements[name].transforms.translateY = o.transforms.translateY;
        this.elements[name].transforms.scaleX = o.transforms.scaleX;
        this.elements[name].transforms.scaleY = o.transforms.scaleY;
      }
    }
  ...
  drawScene() {
    ...
    for (const name in this.elements) {
      if (Object.prototype.hasOwnProperty.call(this.elements, name)) {
        const object = this.elements[name];
...
class Slider {
  ...
  setSlider() {
    if (((window.innerWidth / window.innerHeight) < 1) || window.innerWidth < 769) {
      this.storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-slider`, {
        pagination: {
...
/***/ "./source/js/modules/win-canvas-animation.js":
/*!***************************************************!*\
  !*** ./source/js/modules/win-canvas-animation.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WinCanvasAnimation; });
/* harmony import */ var _helpers_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/animation.js */ "./source/js/helpers/animation.js");
/* harmony import */ var _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scene-2d.js */ "./source/js/modules/scene-2d.js");
/* harmony import */ var _helpers_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/utils.js */ "./source/js/helpers/utils.js");
...
class WinCanvasAnimation extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
...
/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/menu.js */ "./source/js/modules/menu.js");
/* harmony import */ var _modules_footer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/footer.js */ "./source/js/modules/footer.js");
/* harmony import */ var _modules_chat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/chat.js */ "./source/js/modules/chat.js");
/* harmony import */ var _modules_result_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/result.js */ "./source/js/modules/result.js");
...
/* harmony import */ var _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/full-page-scroll */ "./source/js/modules/full-page-scroll.js");
/* harmony import */ var _modules_base_page_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/base-page.js */ "./source/js/modules/base-page.js");
/* harmony import */ var _modules_rules_page_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/rules-page.js */ "./source/js/modules/rules-page.js");
/* harmony import */ var _modules_animation_text_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/animation-text.js */ "./source/js/modules/animation-text.js");
/* harmony import */ var _modules_slider_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/slider.js */ "./source/js/modules/slider.js");
...
// init modules
Object(_modules_base_page_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
Object(_modules_mobile_height_adjust_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
Object(_modules_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
Object(_modules_footer_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_modules_chat_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_modules_result_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
...
Object(_modules_rules_page_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
Object(_modules_heading_animation_js__WEBPACK_IMPORTED_MODULE_12__["default"])();

const slider = new _modules_slider_js__WEBPACK_IMPORTED_MODULE_11__["default"]();
slider.init();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_7__["default"](
    () => {
      slider.revertTheme();
    },
    () => {
...
const animationTitle = new _modules_animation_text_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.js-animation-text`, 400);
const animationIntroDate = new _modules_animation_text_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.intro__date`, 400, 550);
